---
title: "Changelog"
description: "Release history for the Memory TypeScript SDK."
---

Track what's new, changed, and fixed in `@socialproof/memory`.

For the latest version, see the [npm package page](https://www.npmjs.com/package/@socialproof/memory).
