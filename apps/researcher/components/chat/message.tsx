      ...
      >
        ...
        >
          ...
          {message.parts?.map((part, index) => {
            ...
            // Hide intermediate text between tool calls (LLM narrating its tool usage)
            if (type === "text" && message.role === "assistant") {
              const parts = message.parts ?? [];
              const hasToolCalls = parts.some((p) => p.type.startsWith("tool-"));
              if (hasToolCalls) {
            ...
            // Hide all tool call UI — only show final text response
