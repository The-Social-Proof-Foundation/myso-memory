...
export const WALLET_TYPES = {
  slush: {
    name: "Slush Wallet",
    installUrl: "https://chromewebstore.google.com/detail/slush-myso-wallet/bkbnpojckbglpdapinihmmfbncjejmgk",
    // Wallet Standard detection (wallet may identify as "Slush" or "MySo Wallet")
    detectionNames: ["slush", "myso wallet"],
  },
} as const;
...
export const ZKLOGIN_CONFIG = {
  // MySo network (testnet or mainnet)
  network: (process.env.NEXT_PUBLIC_MYSO_NETWORK || "mainnet") as "testnet" | "mainnet",
  ...
  // Session duration in hours (aligned with MySo epochs ~24h)
