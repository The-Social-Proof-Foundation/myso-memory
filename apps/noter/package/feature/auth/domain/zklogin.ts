...
import { generateNonce, generateRandomness } from "@socialproof/myso/zklogin";
 ...
 * This should be fetched from the MySo network in the API layer
 */
...
// ═══════════════════════════════════════════════════════════════
// MySo Address Truncation (UI Helper)
// ═══════════════════════════════════════════════════════════════

/**
 * Truncate MySo address for display
 * Example: 0x1234...5678
 */
export function truncateMySoAddress(address: string, chars: number = 4): string {
