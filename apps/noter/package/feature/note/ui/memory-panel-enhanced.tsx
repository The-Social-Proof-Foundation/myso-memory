        ...
        <div className="space-y-2">
          ...
          {isExpanded && (
            <>
              ...
              {memory.status === "saved" && memory.memoryMemoryId && (
                <div className="space-y-1.5 py-2">
                  ...
                  <div className="space-y-1 text-xs text-muted-foreground font-mono">
                    <div className="flex items-center justify-between gap-2">
                      <span className="truncate">Memory: {memory.memoryMemoryId.slice(0, 12)}...</span>
                      <Button
                        variant="ghost"
                        size="sm"
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          // TODO: Add link to MySo Explorer
                          toast.info("Opening in MySo Explorer...");
                        }}
                      >
                    ...
                    {memory.memoryBlobId && (
                      <div className="truncate">Blob: {memory.memoryBlobId.slice(0, 12)}...</div>
                    )}
                  </div>
                </div>
              )}
