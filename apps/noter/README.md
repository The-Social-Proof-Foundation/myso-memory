...
AI assistant platform powered by MySo blockchain zkLogin authentication.
...
- **MySo Integration**: Blockchain-based identity without traditional wallets
...
- **AI**: Vercel AI SDK v6
- **Blockchain**: MySo Network (zkLogin)
...
Users authenticate using Google OAuth and receive a unique MySo blockchain address:
