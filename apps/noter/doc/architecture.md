...
Noter = MySo AI assistant platform. Chat-based AI interaction with MySo blockchain integration, zkLogin authentication, and tool execution.
...
- zkLogin authentication: MySo address-based identity
...
- **AI**: Vercel AI SDK v6
- **Auth**: zkLogin (MySo blockchain-based authentication)
