          ...
          <>
            ...
            <div className="space-y-0.5">
              <div className="flex items-center gap-1 px-1 py-0.5">
                ...
                <span className="text-xs font-medium">Memory Account</span>
              </div>
              ...
              {mysoAddress && (
                <div className="flex items-center gap-1">
                  <div className="flex-1 min-w-0 bg-secondary px-2 py-2">
                    <p className="text-[10px] text-muted-foreground">MySo Address</p>
                    <code className="text-xs truncate block">{truncateAddress(mysoAddress)}</code>
                  </div>
                  <CopyButton value={mysoAddress} label="address" />
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        variant="secondary"
                        size="icon-sm"
                        onClick={() => window.open(`https://mysoscan.xyz/testnet/account/${mysoAddress}`, "_blank")}
                      >
                        <ExternalLink className="size-3" />
                      </Button>
                    </TooltipTrigger>
                    <TooltipContent>View on MySoscan</TooltipContent>
                  </Tooltip>
                </div>
              )}
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        variant="secondary"
                        size="icon-sm"
                        onClick={() => window.open(`https://mysoscan.xyz/testnet/object/${user.delegateAccountId}`, "_blank")}
                      >
                        <ExternalLink className="size-3" />
                      </Button>
                    </TooltipTrigger>
