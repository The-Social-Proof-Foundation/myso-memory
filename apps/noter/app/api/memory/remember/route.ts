/**
 * Memory Remember API — analyzes note text and extracts facts to Memory.
...
/** Resolve user's Memory key from session header. */
...
export async function POST(req: Request) {
  try {
    ...
    if ((!key || !accountId) && (!process.env.MEMORY_KEY || !process.env.MEMORY_ACCOUNT_ID)) {
